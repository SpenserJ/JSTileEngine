...
$(function() {
  ...
  libraries.tileset.callback = function() {
    ...
    sprite3 = new Sprite({ path: 'sprites/character/gramps.png', tileSize: [32, 32], libraries: libraries });
    sprite3.callback = function() {
      sprite3.drawSpriteToCanvas(4,11,canvas,3,2);
    }
    sprite3.load();
    
    players['player-1'] = new Player({ libraries: libraries, playerID: 'player-1' });
